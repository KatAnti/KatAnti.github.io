  ...
  function D(t, v, o) {
    ...
    function R(t) {
      ...
      var m,
        ...
        if (h && (r = y.xNumSteps[e]), r || (r = d - f), !1 !== f && void 0 !== d) for (r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1) {
          for (u = (a = (o = y.toStepping(n)) - w) / m, p = a / (c = Math.round(u)), i = 1; i <= c; i += 1) {
    ...
    function q(t) {
      var e,
          ...
          o,
          a,
          s = 100 * (t - (e = l, r = v.ort, n = e.getBoundingClientRect(), i = e.ownerDocument, o = i.documentElement, a = gt(i), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (a.x = 0), r ? n.top + a.y - o.clientTop : n.left + a.x - o.clientLeft)) / T();
    ...
    return ht(e = h, v.cssClasses.target), 0 === v.dir ? ht(e, v.cssClasses.ltr) : ht(e, v.cssClasses.rtl), 0 === v.ort ? ht(e, v.cssClasses.horizontal) : ht(e, v.cssClasses.vertical), ht(e, "rtl" === getComputedStyle(e).direction ? v.cssClasses.textDirectionRtl : v.cssClasses.textDirectionLtr), l = A(e, v.cssClasses.base), function (t, e) {
...
var mnt = ["янв", "фев", "мар", "апр", "мая", "июн", "июл", "авг", "сент", "окт", "нояб", "дек"];
var dayW = ["воскресенье", "понедельник", "вторник", "среда", "четверг", "пятница", "суббота"];
...
function clock() {
  ...
  $(".header-date").html(dayW[currentDate.getDay()] + " " + day + " " + mnt[currentDate.getMonth()] + " " + hrs + ":" + min);
}
...
daysWrappers[count].style.fontWeight = "bold";
var orderOfDay = 1;

for (var _i = count; _i < daysWrappers.length; _i++) {
  daysWrappers[_i].classList.add("order".concat(orderOfDay));

  orderOfDay++;
}

for (var _i2 = 0; _i2 < count; _i2++) {
  daysWrappers[_i2].classList.add("order".concat(orderOfDay));
...
var loginBtnPopup = document.querySelector(".login-btn");
var pickGiftPopup = document.querySelector(".pick-gift-popup");
var pickGiftBtnPopup = document.querySelector(".pick-gift-popup-btn");

var initPopUp = function initPopUp(button, popup, overlay) {
  var closeButtonPopup = popup.querySelector(".close_popup");
...
if (loginBtnPopup) {
  initPopUp(loginBtnPopup, loginPopup, mainOverlay);
}

if (loginBtnPopup) {
  initPopUp(pickGiftBtnPopup, pickGiftPopup, mainOverlay);
}

var pickGiftslider = document.getElementById('pick-gift-slider-price');
var pickGiftsliderMin = document.getElementById('pick-gift-slider-price-controls-min');
var pickGiftsliderMax = document.getElementById('pick-gift-slider-price-controls-max');
var catalogPriceSlider = document.getElementById('catalog-filter-slider-price');
var catalogPriceSliderMin = document.getElementById('catalog-filter-slider-price-min');
var catalogPriceSliderMax = document.getElementById('catalog-filter-slider-price-max');

var makeNewPriceSlider = function makeNewPriceSlider(slider, min, max) {
  if (slider) {
...
makeNewPriceSlider(pickGiftslider, pickGiftsliderMin, pickGiftsliderMax);
makeNewPriceSlider(catalogPriceSlider, catalogPriceSliderMin, catalogPriceSliderMax);
var addFieldsetButton = document.querySelector('.custom-order-form-add-fieldset-btn');
var temlateFieldset = "\n<div class=\"fieldset\">\n    <label class=\"custom-order-form-textarea-wrapper\">\n        \u041E\u043F\u0438\u0448\u0438\u0442\u0435 \u0442\u043E\u0432\u0430\u0440\n        <textarea class=\"custom-order-form-discription\" rows=\"4\"></textarea>\n    </label>\n    <label class=\"custom-order-form-download-img\">\n        \u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0438\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435\n        <input type=\"file\" accept=\".png, .jpg, .jpeg\">\n    </label>\n    <label class=\"custom-order-form-input-wrapper\">\n        \u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0442\u043E\u0432\u0430\u0440\u0430\n        <input class=\"custom-order-form-input\" type=\"text\">\n    </label>\n    <label class=\"custom-order-form-input-wrapper\">\n        \u041A\u043E\u0433\u0434\u0430 \u0412\u044B \u0445\u043E\u0442\u0438\u0442\u0435 \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u0442\u043E\u0432\u0430\u0440?\n        <input class=\"custom-order-form-input\" type=\"text\">\n    </label>\n</div>";

if (addFieldsetButton) {
  addFieldsetButton.addEventListener('click', function (evt) {
    evt.preventDefault();
    addFieldsetButton.insertAdjacentHTML('afterend', temlateFieldset);
    addFieldsetButton.style.display = 'none';
  });
}

var filterOpenBtns = document.querySelectorAll('.main-filters-item-btn');

var _loop = function _loop(_i3) {
  filterOpenBtns[_i3].addEventListener('click', function (evt) {
    evt.preventDefault();
    var content = filterOpenBtns[_i3].nextElementSibling;
    content.classList.toggle('show');

    filterOpenBtns[_i3].classList.toggle('open');
  });
};

for (var _i3 = 0; _i3 < filterOpenBtns.length; _i3++) {
  _loop(_i3);
}

$('.photogallery-slider-main').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  fade: true,
  infinite: false,
  dots: true,
  asNavFor: '.photogallery-slider-aside'
});
$('.photogallery-slider-aside').slick({
  slidesToShow: 4,
  slidesToScroll: 1,
  infinite: false,
  vertical: true,
  arrows: false,
  asNavFor: '.photogallery-slider-main',
  focusOnSelect: true
});
var counterPlusBttn = document.querySelector(".product-amount-btn-plus");
var counterMinusBttn = document.querySelector(".product-amount-btn-minus");
var counterInput = document.querySelector(".product-amount-field");

if (counterPlusBttn) {
  counterPlusBttn.addEventListener("click", function () {
    console.log('click');
    var valueInput = +counterInput.value;
    valueInput += 1;
    counterInput.value = valueInput;
  });
  counterMinusBttn.addEventListener("click", function () {
    var valueInput = +counterInput.value;
...
var detailTabsBtns = document.querySelectorAll('.detail-product-card-tab');
var detailTabs = document.querySelectorAll('.detail-product-card-tab-section');

if (detailTabsBtns.length > 1) {
  var _loop2 = function _loop2(_i4) {
    detailTabsBtns[_i4].addEventListener('click', function (evt) {
      evt.preventDefault();

      var indicatorBtn = detailTabsBtns[_i4].getAttribute('data-label');

      for (var j = 0; j < detailTabs.length; j++) {
        detailTabs[j].classList.remove('show');
        var current = detailTabs[j].getAttribute('data-label');

        if (indicatorBtn === current) {
          detailTabs[_i4].classList.add('show');
        }
      }
    });
  };

  for (var _i4 = 0; _i4 < detailTabsBtns.length; _i4++) {
    _loop2(_i4);
  }
}
